...
public class Stats implements InventoryProvider {
    ...
    public void init(Player player, InventoryContents contents) {
        ...
        contents.set(1, 4, ClickableItem.empty(new ItemBuilder(Skull.getPlayerSkull(p.getName()))
                ...
                .lore("&7You were the &a" + TextUtils.getDayNumberSuffix(up.getJoinNumber()) + "&7 to log into Corrupt Prisons!")
                ...
                .lore("&7Kill/Death Ratio: " + (up.getDeaths() > 0 ? "&a" + TextUtils.addCommas(up.getKills() / up.getDeaths()) : "&cN/A"))
                .build()));
    }
